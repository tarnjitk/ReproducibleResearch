...
```{r}
        ...
        ggplot(activityTimeSeries, aes(x=Time, y=MeanNumberOfStepsWD), color = "red") + geom_line() + xlab("Time(Hours)") + ylab("Mean number of steps") +   geom_line(aes(x=Time, y=MeanNumberOfStepsWE)) 
```
